...
void Widget::paintEvent(QPaintEvent *)
{
    ...
    painter.drawText(rect, Qt::AlignVCenter | Qt::AlignRight, tr("AlignVCenter\nAlignRight"));
    painter.drawText(rect, Qt::AlignBottom, tr("AlignBottom"));
    painter.drawText(rect, Qt::AlignHCenter | Qt::AlignBottom, tr("AlignHCenter\nAlignBottom"));
    ...
    painter.drawText(130, 80, tr("helloqt"));
